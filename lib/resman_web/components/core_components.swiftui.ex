defmodule ResmanWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `ResmanWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ResmanWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ResmanWeb.Gettext, "errors", msg, opts)
    end
  end
